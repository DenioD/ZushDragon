    ...
    conn->doRPC(makePayload(method), [=] (const json& reply) {   
	    ...
	    // TODO: use getinfo.synced
            ...
            QString statusText = QString() %
                ...
                " TestCoin" //% QString::number( (double) Settings::getInstance()->getZECPrice() ) %
...
void RPC::checkForUpdate(bool silent) {
    ...
    QUrl cmcURL("https://api.github.com/repos/MyHush/ZushDragon/releases");
            ...
            if (reply->error() == QNetworkReply::NoError) {
                ...
                if (maxVersion > currentVersion && (!silent || maxVersion > maxHiddenVersion)) {
                    ...
                    if (ans == QMessageBox::Yes) {
                        QDesktopServices::openUrl(QUrl("https://github.com/MyHush/ZushDragon/releases"));
                    } else {
...
void RPC::shutdownZcashd() {
    ...
    connD.status->setText(QObject::tr("Please enhance your calm and wait for ZushDragon to exit"));
